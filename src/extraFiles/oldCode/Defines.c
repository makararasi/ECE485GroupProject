...
void print_hit_miss(void)
{
	printf("----------------------------------------------------\n");
	printf("----------------------------------------------------\n");
	printf("Number of data hits  : %d\n", hits);
	printf("Number of data misses: %d\n", misses);
	printf("Number of instruction hits  : %d\n", hitsI);
	printf("Number of instruction misses: %d\n", missesI);
	printf("Number of reads : %d\n", read_result);
	printf("Number of writes: %d\n", write_result);

	float avg_hit = (float)(hits) / (float)(hits + misses);
	float avg_hitI = (float)(hitsI) / (float)(hitsI + missesI);
	printf("Data Cache hit ratio: %.4f = %.2f %%\n", avg_hit, (avg_hit * 100));
	printf("Instruction Cache hit ratio: %.4f = %.2f %%\n", avg_hitI, (avg_hitI * 100));
	printf("----------------------------------------------------\n");
	printf("----------------------------------------------------\n");
}
